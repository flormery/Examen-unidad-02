 ...
 */
package pe.edu.upeu.examenmefl2.gui;
...
import pe.edu.upeu.examenmefl2.dao.ResultadoDAO;
import pe.edu.upeu.examenmefl2.dao.ResultadoDaoI;
import pe.edu.upeu.examenmefl2.modelo.ResultadoTO;
import pe.edu.upeu.examenmefl2.util.MsgBox;
import pe.edu.upeu.examenmefl2.util.UtilsX;
...
public class Inicio extends javax.swing.JFrame {
    ...
    public Inicio() {
        initComponents();
        //Titulo
        this.setTitle("Examen unidad 2 MEFLL");
        //Icono
        try {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ALUMNA:Mery Elizabeth Flores Llanque");
    ...
    private void btnIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarActionPerformed
        ...
        lblNombre.setText("de "+uTO.getNombreJugador1()+" (X)");
        ListarResultado();
