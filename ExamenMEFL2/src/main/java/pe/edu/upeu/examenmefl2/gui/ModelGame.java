...
public class ModelGame {
            ...
            if (tablero[i][j] == null) {
                ...
                if (!end) {
                    if (turno.equals("X")) {
                        ...
                        view.lblNombre.setText("de "+ to.getNombreJugador2()+" (0)");
                    } else {
                        turno = "X";
                        ResultadoTO to = view.uTO;
                        view.lblNombre.setText("de" + to.getNombreJugador1()+" (X)");
                    }
                } else {
                    terminarJuego(view);
    ...
    private void terminarJuego(Inicio view) {
        if (draw) {
            ...
            JOptionPane.showMessageDialog(null, "Empate de los jugadores");
        } else {
            if (turno.equals("X")) {
                victoriasJ1++;
    ...
    void AnularGame(JLabel[][] casillas,Inicio view) {
        ...
        rDao.update(to);
        view.ListarResultado();
        JOptionPane.showMessageDialog(null, "P. Anulado");
    }
}
